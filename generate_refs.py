...
if __name__ == '__main__':
    ...
    parser.add_argument('md_directory', nargs='+', type=str,
        help='desired input path(s), can be any combination of valid directories and files')
    parser.add_argument('-f', '--flag-dead-refs', action='store_true',
        help='flag references that are not an exact match for any sections present in md_directory')
    parser.add_argument('-d', '--dry-run', action='store_true',
        help='print out references that would have been replaced in provided md files')
    ...
    parser.add_argument('--save-flags', type=str, action='store',
        help='save output that would have been generated by --flag-dead-refs to provided filepath')
    parser.add_argument('--whitelist', type=str, action='store',
        help='path to file containig newline separated list of strings to ignore')
